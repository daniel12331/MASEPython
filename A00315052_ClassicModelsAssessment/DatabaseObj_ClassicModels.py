...
class DBConnection:
    ...
    def productLineSummary(self):
        ...
        plt.bar(self.products['productLine'].value_counts().index, self.products['productLine'].value_counts().values, color='blue',
                width=0.4)

        plt.xlabel("Product Line")
        plt.ylabel("Value in store")
        plt.title("Value of product in stock")
        plt.show()
